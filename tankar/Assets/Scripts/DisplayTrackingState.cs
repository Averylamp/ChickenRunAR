...
public class DisplayTrackingState : MonoBehaviour
{
    ...
    void Update()
    {
        string local_position = GameObject.Find("Terrain").transform.position.ToString();
        string local_rotation = GameObject.Find("AR Session Origin").transform.rotation.ToString();
